...
- Three more: Amber (the orange terminal), Famicom (the console shell's cream, crimson and gold) and Virtual Boy (red LEDs on black). Every theme in the menu now shows a little two-color dot of its palette next to its name.
